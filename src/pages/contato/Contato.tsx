            ...
            <div className="section-card">
                    <div className="card-profile card-1">
                        ...
                        <div className="container-redes">
                            ...
                            <p>Dev FullStack</p>
                            <a href="https://www.linkedin.com/in/danielle-okuma/">
                                <span className="flex">
                            ...
                            <a href="https://github.com/DaniOkuma">
                                <span className="flex">
            ...
            <div className="section-card">
                <div className="card-profile card-3">
                    ...
                    <div className="container-redes">
                            ...
                            <p>Dev FullStack</p>
                            <a href="https://www.linkedin.com/in/luiz-eduardosc/">
                            <span className="flex">
                                <LinkedinLogo size={25} weight='bold'/> Linkedin
                            </span>
                            </a>
                ...
                <div className="card-profile card-4">
                    ...
                    <div className="container-redes">
                            ...
                            <p>Dev FullStack</p>
                            <a href="https://www.linkedin.com/in/mlls/">
                                <span className="flex">
                                    <LinkedinLogo size={25} weight='bold'/> Linkedin
                                </span>
                            </a>
