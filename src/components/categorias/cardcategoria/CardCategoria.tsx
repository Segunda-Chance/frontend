...
function CardCategoria({ categoria }: CardCategoriaProps) {
    return (
        <div className='flex flex-col rounded-2xl overflow-hidden justify-between shadow-lg '>
            ...
            <p className='p-6 text-2xl bg-rose-50 text-rose-950 h-full font-semibold'>{categoria.nomeCategoria}</p>

            <header className='py-2 px-6 bg-rose-950 text-rose-50 font-bold text-2xl'>
                Tipo
            </header>
            <p className='p-6 text-2xl bg-rose-50 text-rose-950 h-full font-semibold'>{categoria.tipo}</p>
